...
--  Uses INSERT IGNORE for MySQL compatibility
--  (skips insert if record already exists)
-- ─────────────────────────────────────────────

-- ── Users ─────────────────────────────────────
-- Password: admin123
INSERT IGNORE INTO users (first_name, last_name, username, email, password, role, created_at) VALUES
...
-- ── Courses ───────────────────────────────────
-- Mohammed Darras courses
INSERT IGNORE INTO courses (course_code, title, description, instructor_name, category, status, max_students, duration_weeks, created_at) VALUES
